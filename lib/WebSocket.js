...
let WebSocketClient = function (cred, params) {
     ...
     this.connect = function (params, callbacks) {
          return new Promise((resolve, reject) => {
               ...
               //ws = new web_socket(url, null, { rejectUnauthorized: false }); // original code

               ws = new web_socket(url, { rejectUnauthorized: false }); // modified to fix - SyntaxError: An invalid or duplicated subprotocol was specified
